...
return(
  ...
  <h1 className="purpose-about">What is our purpose?</h1>
    <div className="our-purpose">
       <img className="map-about" src="../../../public/purpose-img.png"></img>
    ...
    <CardOurServices  variant ="about-mission" title="Mission" description="Our mission at Zenvo Studio is to exceed client expectations by transforming ideas into captivating visual experiences. With expertise in UX/UI and frontend, we merge functionality with creativity, leaving a lasting mark through exceptional design." img="/public/Mission.png"></CardOurServices>
    </div>
    <div className="vision">
    <CardOurServices  variant ="about-vision" title="Vision" description="At Zenvo Studio, our vision is to lead the creation of innovative visual solutions that set trends in the design industry. We aim to build strong relationships with clients, elevating design quality and aesthetics in every challenge. As a benchmark for inspiring visual experiences, we contribute to the success of brands in the digital world." img="/public/Vission.png"></CardOurServices>
    </div>
    </div>
    </div>
    ...
    <div className="benefits">
        ...
        <CardBenefits variant ="about-creative" img="/public/Pencil.png" title="Creativity without limits" description="Our passion for innovation and originality allows us to offer unique and memorable design solutions that stand out in a saturated market."></CardBenefits>
        </div>
        <div className="client">
        <CardBenefits  variant ="about-client" img="/public/Pencil.png" title="Client-centric approach" description="We value our clients' needs and objectives, collaborating closely with them to ensure that each project is customized and meets their expectations.
"></CardBenefits>
        </div>
        <div className="results">
        <CardBenefits variant ="about-results" img="/public/Pencil.png" title="Exceptional results" description="We are committed to delivering high-quality results on every project, using our experience and skills to exceed expectations and generate lasting impact."></CardBenefits>
        </div>
        </div>
